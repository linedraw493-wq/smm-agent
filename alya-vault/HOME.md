...
- [[status]] — состояние на сегодня (горячее); [[status-log]] — хронология
  по сессиям.
...
- `../projects/` — выпуски: сценарий, сырьё, работа, готовое, `run.md`.
  ...
  `work/sky.py`). `2026-08-25-m4ksi-den-osnovatelya` — новое сырьё без
  звука (парковка → машина → дорога → работа в парке → жест в беседке),
  контур M4ksi: разбор `razbor.md` + пять вариантов крючка в `script.md`,
  сборки нет, ждёт выбора владельца. Наружу не вышел ни один.
